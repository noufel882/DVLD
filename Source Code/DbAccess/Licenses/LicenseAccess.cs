...
namespace DbAccess.LicenseAccess
{
    public class LicenseAccess
    {
        ...
        {
            bool isFound = false;
            string query = $"SELECT * FROM {AccessSettings.LicensesTableName} WHERE LicenseID = @LicenseID";
        ...
        public static DataTable GetLicensesList()
        {
            ...
            string query = $"SELECT * FROM {AccessSettings.LicensesTableName} ";
        ...
        public static DataTable GetDriverLicenses(int DriverID)
        {
            ...
            string query = @" 
                           SELECT  Licenses.LicenseID,Licenses.ApplicationID,LicenseClasses.ClassName , Licenses.IssueDate , Licenses.ExpirationDate , Licenses.IsActive FROM Licenses
        ...
        public static int AddNewLicense(int ApplicationID, int DriverID, int LicenseClass,
            ...
            float PaidFees, byte IssueReason, int CreatedByUserID)
        {
            int LicenseID = -1;
            string query = $@"
                INSERT INTO {AccessSettings.LicensesTableName}
            ...
            float PaidFees, bool IsActive, byte IssueReason, int CreatedByUserID)
        {
            int rowsAffected = 0;
            string query = $@"
                UPDATE {AccessSettings.LicensesTableName}
        ...
        {
            int rowsAffected = 0;
            string query = $@"UPDATE {AccessSettings.LicensesTableName} 
                              SET IsActive = 0 
                              WHERE LicenseID = @LicenseID";
